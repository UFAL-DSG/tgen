        ...
        for feat in spec:
            ...
            if func_name == 'prob':
                ...
                if func_name.lower() == 'same_as_current':
                    ...
                    feat_func = partial(self.value, scope_func=scope_func, attrib=func_params[0])
                else:
