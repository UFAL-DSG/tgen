...
REALIZATIONS = {
    ...
    'rating': {
        "1 out of 5": [
            ...
            r"(?:low|bad|poor)(?:ly)?(?:[ -]+\w+){0,2}[ -]+(?:rat(?:ings?|ed)|reviews?|standards?|quality)",
        ],
        "3 out of 5": [
            "(?:3|three)[- ]+stars?",
            "(?:3|three)(?: out)? of (?:5|five)",
            r"(?:rat(?:ings?|e[ds]?)|reviews?|standards?|quality)(?: \w+){0,2} (?:as )?average",
            r"average(?:ly)?(?:[ -]+\w+){0,2}[ -]+(?:rat(?:ings?|ed)|reviews?|standards?|quality)",
        ],
        "5 out of 5": [
            "(?:5|five)[- ]+stars?",
            "(?:5|five)(?: out)? of (?:5|five)",
            r"(?:rat(?:ings?|e[ds]?)|reviews?|standards?|quality)(?: \w+){0,2} (?:as )?high",
            r"(?:high|excellent|very good|great)(?:ly)?(?:[ -]+\w+){0,2}[ -]+(?:rat(?:ings?|ed)|reviews?|standards?|quality)",
        ],
        "high": [
            "(?:5|five)[- ]+stars?",
            "(?:5|five)(?: out)? of (?:5|five)",
        ...
        "low": [
            ...
            "(?:1|one)(?: out)? of (?:5|five)",
            r"(?:rat(?:ings?|e[ds]?)|reviews?|standards?|quality)(?: \w+){0,2} (?:as )?(?:low|bad|poor)",
            r"(?:low|bad|poor|does ?n['o]t have good|(?:is)?n['o]t (?:well|good))(?:ly)?(?:[ -]+\w+){0,2}[ -]+(?:rat(?:ings?|ed)|reviews?|standards?|quality)",
        ],
    },
}
